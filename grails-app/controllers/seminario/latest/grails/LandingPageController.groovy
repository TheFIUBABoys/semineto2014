...
class LandingPageController {
    ...
    def downKeywords = ["no viene": 0.5, "no sale": 0.2, "parado": 0.4, "demorado": 0.4]
    def upKeywords = ["en horario": 0.5, "saliendo": 0.2, "viajando": 0.4, "llegando": 0.3]

    def index() {}

    def tweets() {
        def query = new Query("tren tigre");
