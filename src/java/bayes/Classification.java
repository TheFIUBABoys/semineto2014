...
public class Classification<T, K> {
    ...
    /**
     * Constructs a new bayes.Classification with the parameters given and a default
     * probability of 1.
     *
    ...
    /**
     * Constructs a new bayes.Classification with the parameters given.
     *
     * @param featureset The featureset.
     * @param category The category.
    ...
    public String toString() {
        return "bayes.Classification [category=" + this.category
